...
const BookingForm = ({ accommodation, onSubmit }) => {
  ...
  const { priceCalculation, availability } = useSelector(
    (state) => state.booking,
  );
  ...
  const isFormValid =
    formData.checkIn && formData.checkOut && formData.guests > 0;
      ...
      {priceCalculation && (
        <div style={styles.priceBreakdown}>
          ...
          <div style={styles.priceRow}>
            <span>
              KSh {accommodation.price_per_night} x {priceCalculation.nights}{" "}
              nights
            </span>
          ...
          <div style={styles.priceRow}>
            ...
            <span style={styles.totalValue}>
              KSh {priceCalculation.total_price}
            </span>
          </div>
        </div>
      )}
