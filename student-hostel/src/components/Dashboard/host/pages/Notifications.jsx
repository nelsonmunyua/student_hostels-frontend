...
const HostNotifications = () => {
  ...
  const fetchNotifications = useCallback(async () => {
    try {
      ...
      const response = await hostApi.getNotifications();
      ...
      setPagination((prev) => ({
        ...
        pages: 1,
        unreadCount: response.notifications?.filter((n) => !n.is_read).length || 0,
      }));
    } catch (err) {
  ...
  const handleMarkAsRead = async (notificationId) => {
    try {
      await hostApi.markNotificationRead(notificationId);
  ...
  const getNotificationIcon = (title) => {
    ...
    if (lowerTitle.includes("payment") || lowerTitle.includes("paid") || lowerTitle.includes("earnings")) {
    ...
    if (lowerTitle.includes("room") || lowerTitle.includes("hostel") || lowerTitle.includes("listing")) {
...
const getMockNotifications = () => [
  {
    ...
    message:
      "You have a new booking request from a student for University View Hostel. Review and accept within 24 hours.",
    is_read: false,
  ...
  },
  {
    ...
    message:
      "Payment of KSh 8,500 has been received for booking at Central Student Living. Funds will be transferred to your account.",
    is_read: false,
  ...
  },
  {
    ...
    title: "New Review",
    message:
      "A student left a 5-star review for Green Valley Hostel. Great job maintaining excellent ratings!",
    is_read: true,
  ...
  },
  {
    ...
    message:
      "Your new listing at University View Hostel has been approved and is now visible to students.",
    is_read: true,
  ...
  },
  {
    ...
    message:
      "Reminder: Check-in for booking at Central Student Living is scheduled for tomorrow. Prepare the room for the guest.",
    is_read: true,
  ...
  },
  {
    ...
    message:
      "Your monthly earnings report is ready. You earned KSh 45,000 from 12 bookings this month.",
    is_read: true,
