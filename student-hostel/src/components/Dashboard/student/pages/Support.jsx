...
const StudentSupport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await studentApi.createSupportTicket(formData);
    ...
    <div style={styles.container}>
      ...
      <div style={styles.contactGrid}>
        <div style={styles.contactCard}>
          ...
          <p style={styles.contactText}>support@studenthostel.com</p>
        ...
        <div style={styles.contactCard}>
          ...
          <p style={styles.contactText}>+254 700 000 000</p>
          <p style={styles.contactSubtext}>Mon-Fri, 9am-5pm</p>
        </div>
        ...
        <div style={styles.faqList}>
          <div style={styles.faqItem}>
            <details style={styles.faqDetails}>
              ...
              <p style={styles.faqAnswer}>
                Browse available accommodations, click "View Details" to see more
                information, and use the "Book Now" button to start your booking
                process. You'll need to select your move-in date and complete the
          ...
          <div style={styles.faqItem}>
            <details style={styles.faqDetails}>
              ...
              <p style={styles.faqAnswer}>
                Yes, you can cancel your booking from the "My Bookings" page.
                Cancellations made at least 7 days before check-in are eligible
                for a full refund. Please refer to our cancellation policy for
                more details.
              </p>
            </details>
          </div>
          ...
          <div style={styles.faqItem}>
            <details style={styles.faqDetails}>
              ...
              <p style={styles.faqAnswer}>
                We accept various payment methods including M-Pesa, credit/debit
                cards, and bank transfers. Payment can be made through the
                "Payments" section in your dashboard or during the booking
                process.
              </p>
            </details>
          </div>
          ...
          <div style={styles.faqItem}>
            <details style={styles.faqDetails}>
              ...
              <p style={styles.faqAnswer}>
                ...
                host directly through the messaging feature or submit a support
                request through your dashboard. Our support team is available 24/7
          ...
          <div style={styles.faqItem}>
            <details style={styles.faqDetails}>
              ...
              <p style={styles.faqAnswer}>
                After completing your booking, you can leave a review from the
                "My Reviews" section in your dashboard. Click "Write Review" for
                any completed bookings that haven't been reviewed yet.
              </p>
            </details>
          </div>
        </div>
...
const getMockTickets = () => [
  {
    ...
    message:
      "I made a booking yesterday but haven't received a confirmation email yet.",
    status: "in_progress",
    booking_id: null,
  ...
  },
  {
    ...
    message:
      "I was charged twice for my booking at University View Hostel. Please look into this.",
    status: "resolved",
    booking_id: 1,
  ...
  },
  {
    ...
    message:
      "I would like to change my room from single to double at Green Valley Hostel.",
    status: "open",
    booking_id: 3,
