...
const Overview = () => {
  ...
  const quickActions = [
    { label: "Add New Hostel", icon: Home, color: "#0369a1" },
    { label: "View All Users", icon: Users, color: "#7c3aed" },
    { label: "Generate Report", icon: Activity, color: "#059669" },
    { label: "Manage Bookings", icon: Calendar, color: "#ea580c" },
  ];
